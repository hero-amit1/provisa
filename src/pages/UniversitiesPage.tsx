      ...
      <section className="section-padding data-scroll-reveal" data-scroll-reveal-animation="slide-up">
        <div className="section-container">
          <div className="text-center mb-12 data-scroll-reveal animate-slide-up">
            <p className="section-subtitle mb-2 animate-fade-in animation-delay-100">Universities</p>
            <h1 className="section-title mb-4 animate-slide-up animation-delay-200">Top universities we are partnered with</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 data-scroll-reveal">
            {universities.map((uni, index) => (
              ...
              >
                <div className="w-20 h-20 bg-muted rounded-full mx-auto mb-4 flex items-center justify-center animate-rotate-in animation-delay-100">
                  <GraduationCap className="h-10 w-10 text-primary" />
                </div>
                <h3 className="font-heading font-semibold text-foreground text-sm">{uni.name}</h3>
                <p className="text-xs text-primary mt-1">{uni.country}</p>
              </div>
            ))}
          </div>
        </div>
